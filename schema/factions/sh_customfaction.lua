...
FACTION.pay = 50
-- Pays $50 Dollars since listed above,
-- the 'FACTION.payTime' are in seconds.
FACTION.payTime = 900
...
-- Set playermodels which players can select from the model panel upon character creation.
FACTION.models = {
	"models/alyx.mdl",
	"models/police.mdl"
}
